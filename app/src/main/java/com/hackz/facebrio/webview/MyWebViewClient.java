package com.hackz.facebrio.webview;
...
import com.hackz.facebrio.activity.MainActivity;
import com.hackz.facebrio.util.Connectivity;
import com.hackz.facebrio.util.Dimension;
import com.hackz.facebrio.util.FileOperation;
import com.hackz.facebrio.util.FloatingActionButton;
import com.hackz.facebrio.util.Miscellany;
import com.hackz.facebrio.util.Offline;
import com.hackz.facebrio.util.OfflinePagesAdapter;
...
public class MyWebViewClient extends WebViewClient {
    ...
    public void onPageFinished(WebView view, String url) {
        ...
        if (url.contains("messages/")) {
            MainActivity.mMenuFAB.hideMenu(true);
        } else {
            MainActivity.mMenuFAB.showMenu(true);
        }
