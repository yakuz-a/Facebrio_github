...
import com.hackz.facebrio.BuildConfig;
...
public class CheckUpdatesTask extends AsyncTask<Void, Void, String> {
    ...
    private static final String URL = "http://arclecorporation.com";
    private static final String NOTES = "https://play.google.com/store/apps/details?id=com.hackz.facebrio";
